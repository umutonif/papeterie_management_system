package com.farida.PapeterieManagementSystem.config;
   ...
   @Override
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
				.antMatchers("/").hasRole("BUYER")
				.antMatchers("/papeteries/showFormForAdd").permitAll()
				.antMatchers("/jobs/*").authenticated()
				.antMatchers("/email/*").authenticated()
				.antMatchers("/css/**").permitAll()
				.antMatchers("/papeteries/showFormForAdd").hasRole("VENDOR")
				.antMatchers("/papeteries/list").hasRole("BUYER")
